...
class SqlController:
    ...
    def InsertPerson(self, id: str, name: str, record: dict) -> None:
    ...
    def UpdatePerson(self, id: str, name, record: dict) -> None:
    ...
    def InsertPersonWithJudgeExist(self, id: str, name: str, record: dict) -> None:
...
if __name__ == '__main__':
    ...
    a = sqlController.SelectPerson('002')
    print(a)
    pass
